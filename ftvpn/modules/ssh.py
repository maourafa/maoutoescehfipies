...
━━━━━━━━━━━━━━━━━
**⚡FORMAT PORT 80 `{DOMAIN}:80@{user.strip()}:{pw.strip()}`
**⚡FORMAT PORT 443`{DOMAIN}:443@{user.strip()}:{pw.strip()}`
**⚡FORMAT UDP     `{DOMAIN}:1-65535@{user.strip()}:{pw.strip()}`
━━━━━━━━━━━━━━━━━
